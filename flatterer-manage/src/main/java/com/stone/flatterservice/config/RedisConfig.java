//package com.stone.flatterservice.config;
//
...
//
//import com.stone.flatterservice.pojo.auth.AccessKey;
//
///**
// * Redis缓存配置类
// * 
...
//	}
//
//	@Bean("accessKeyRedisTemplate")
//	public RedisTemplate<String, AccessKey> redisTemplate(RedisConnectionFactory redisConnectionFactory) {
//		RedisTemplate<String, AccessKey> template = new RedisTemplate<String, AccessKey>();
//		Jackson2JsonRedisSerializer<AccessKey> j = new Jackson2JsonRedisSerializer<AccessKey>(AccessKey.class);
